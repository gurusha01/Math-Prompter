...
Q =  Q_ialg[:250] + Q_alg[:250] 
A =  A_ialg[:250] + A_alg[:250]
T =  T_ialg[:250] + T_alg[:250]
COT = COT_ialg[:250] + COT_alg[:250]
...
model_env = LLaMAForCausalLM.from_pretrained("./alpaca-lora/13B_HF/", load_in_8bit=True, device_map={"": device_env})
...
for _ in range(num_epochs):
    ...
    for batch in tqdm(train_dataloader):
        ...
        if(batch_number%10 == 0):
            ppo_trainer.model.save_pretrained("./openAI_trials/Context/aqua")
