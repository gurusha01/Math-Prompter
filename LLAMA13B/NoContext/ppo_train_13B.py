...
Q_pnc, A_pnc, T_pnc = create_dataset_MATH("./alpaca-lora/MATH/test/counting_and_probability", 1)
Q_NT, A_NT, T_NT = create_dataset_MATH("./alpaca-lora/MATH/test/number_theory", 1)
Q_ialg, A_ialg, T_ialg = create_dataset_MATH("./alpaca-lora/MATH/test/intermediate_algebra", 1)
Q_alg, A_alg, T_alg = create_dataset_MATH("./alpaca-lora/MATH/test/algebra", 1)
